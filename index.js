...
function sortDescendingPrice(hotel1, hotel2) {
  return hotel2.price - hotel1.price;
}
app.get('/hotels/sort/pricing', (req, res) => {
  let pricing = req.query.pricing;
  let result = hotels.slice();
  if (pricing == 'low-to-high') result.sort(sortAscendingPrice);
  else if (pricing == 'high-to-low') result.sort(sortDescendingPrice);
...
function sortDescendingReview(hotel1, hotel2) {
  return hotel2.reviews - hotel1.reviews;
}
app.get('/hotels/sort/reviews', (req, res) => {
  let reviews = req.query.reviews;
  let result = hotels.slice();
  if (reviews == 'low-to-high') result.sort(sortAscendingReview);
  else if (reviews == 'high-to-low') result.sort(sortDescendingReview);
  res.json({ hotels: result });
});
